// Taken from the ImGui repository and slightly adapted
...
#include "glad/glad.h"
//define for imgui to skip loading opengl dunction pointers since they are already loaded through glad
